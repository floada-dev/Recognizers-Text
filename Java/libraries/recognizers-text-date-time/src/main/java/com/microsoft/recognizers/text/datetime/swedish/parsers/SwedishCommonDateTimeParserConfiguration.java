...
public class SwedishCommonDateTimeParserConfiguration extends BaseDateParserConfiguration implements ICommonDateTimeParserConfiguration {
    ...
    public SwedishCommonDateTimeParserConfiguration(DateTimeOptions options) {
        ...
        seasonMap = SwedishDateTime.SeasonMap;
        specialYearPrefixesMap = SwedishDateTime.SpecialYearPrefixesMap;
        cardinalMap = SwedishDateTime.CardinalMap;
        dayOfWeekMap = SwedishDateTime.DayOfWeek;
        dayOfMonth = ImmutableMap.<String, Integer>builder().putAll(super.getDayOfMonth()).putAll(SwedishDateTime.DayOfMonth).build();
        monthOfYear = SwedishDateTime.MonthOfYear;
        numbers = SwedishDateTime.Numbers;
        doubleNumbers = SwedishDateTime.DoubleNumbers;
        writtenDecades = SwedishDateTime.WrittenDecades;
        specialDecadeCases = SwedishDateTime.SpecialDecadeCases;
        ...
        timeParser = new SwedishTimeParser(new SwedishTimeParserConfiguration(this));
