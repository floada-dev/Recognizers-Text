...
public class SwedishDateParserConfiguration extends BaseOptionsConfiguration implements IDateParserConfiguration {

    public SwedishDateParserConfiguration(ICommonDateTimeParserConfiguration config) {

        super(config.getOptions());

        dateTokenPrefix = SwedishDateTime.DateTokenPrefix;
        ...
        dateRegexes = Collections.unmodifiableList(SwedishDateExtractorConfiguration.DateRegexList);
        ...
        weekDayAndDayOfMonthRegex = SwedishDateExtractorConfiguration.WeekDayAndDayOfMonthRegex;
        ...
        relativeDayRegex = RegExpUtility.getSafeRegExp(SwedishDateTime.RelativeDayRegex);
        ...
        sameDayTerms = Collections.unmodifiableList(SwedishDateTime.SameDayTerms);
        plusOneDayTerms = Collections.unmodifiableList(SwedishDateTime.PlusOneDayTerms);
        plusTwoDayTerms = Collections.unmodifiableList(SwedishDateTime.PlusTwoDayTerms);
        minusOneDayTerms = Collections.unmodifiableList(SwedishDateTime.MinusOneDayTerms);
        minusTwoDayTerms = Collections.unmodifiableList(SwedishDateTime.MinusTwoDayTerms);
