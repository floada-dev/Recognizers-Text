...
public class SwedishTimeZone {
    ...
    public static final ImmutableMap<String, Integer> FullToMinMapping = ImmutableMap.<String, Integer>builder()
        .put("centralaustralisk sommar", 630)
        .put("centralaustralisk normal", 570)
        .put("acre", -300)
        .put("central västaustralisk normal", 525)
        .put("central vastaustralisk normal", 525)
        .put("atlantisk sommar", -180)
        .put("östaustralisk sommar", 660)
        .put("ostaustralisk sommar", 660)
        .put("östaustralisk normal", 600)
        .put("ostaustralisk normal", 600)
        .put("afghansk", 270)
        .put("alaska sommar", -480)
        .put("alaska normal", -540)
        .put("almaty", 360)
        .put("amazonsk sommar", -180)
        .put("armenisk", 240)
        .put("amazonsk", -240)
        .put("anadyr", 720)
        .put("aqtöbe/aktiubinsk", 300)
        .put("aqtobe/aktiubinsk", 300)
        .put("argentinsk", -180)
        .put("arabisk normal", 180)
        .put("atlantisk normal", -240)
        .put("västaustralisk normal", 480)
        .put("vastaustralisk normal", 480)
        .put("azorisk sommar", 0)
        .put("azorisk", -60)
        .put("azerbaijansk sommar", 300)
        .put("azerbaijansk", 240)
        .put("bruneisk", 480)
        .put("boliviansk", -240)
        .put("brasiliansk sommar", -120)
        .put("brasiliansk", -180)
        .put("brittisk sommar", 60)
        .put("bangladeshisk normal", 360)
        .put("bhutansk", 360)
        .put("centralafrikansk", 120)
        .put("kokosöarnas", 390)
        .put("kokosoarnas", 390)
        .put("centralamerikansk sommar", -300)
        .put("kubansk sommar", -240)
        .put("centraleuropeisk sommar", 120)
        .put("centraleuropeisk", 60)
        .put("chathamöarnas sommar", 825)
        .put("chathamoarnas sommar", 825)
        .put("chathamöarna normal", 765)
        .put("chathamoarna normal", 765)
        .put("tjojbalsan", 480)
        .put("chamorro normal", 600)
        .put("chuuk", 600)
        .put("cooköarnas", -600)
        .put("cookoarnas", -600)
        .put("chilensk sommar", -180)
        .put("chilensk normal", -240)
        .put("colombiansk", -300)
        .put("centralamerikansk normal", -360)
        .put("kubansk normal", -300)
        .put("kinesisk normal", 480)
        .put("kapverdiansk", -60)
        .put("julö", 420)
        .put("julo", 420)
        .put("påsköns sommar", -300)
        .put("paskons sommar", -300)
        .put("påsköns normal", -360)
        .put("paskons normal", -360)
        .put("östafrikansk", 180)
        .put("ostafrikansk", 180)
        .put("equadoriansk", -300)
        .put("östamerikansk sommar", -240)
        .put("ostamerikansk sommar", -240)
        .put("östeuropeisk sommar", 180)
        .put("osteuropeisk sommar", 180)
        .put("östeuropeisk", 120)
        .put("osteuropeisk", 120)
        .put("östgrönländsk sommar", 0)
        .put("ostgronlandsk sommar", 0)
        .put("östgrönländsk", -60)
        .put("ostgronlandsk", -60)
        .put("östamerikansk normal", -300)
        .put("ostamerikansk normal", -300)
        .put("ytterligare-östeuropeisk", 180)
        .put("ytterligare-osteuropeisk", 180)
        .put("fiji sommar", 780)
        .put("fiji", 720)
        .put("falklandsöarnas sommar", -180)
        .put("falklandsoarnas sommar", -180)
        .put("fernando de noronha", -120)
        .put("galápagos", -360)
        .put("gambiers", -540)
        .put("georgisk normal", 240)
        .put("franska guyana", -180)
        .put("gilbertöarnas", 720)
        .put("gilbertoarnas", 720)
        .put("greenwich", 0)
        .put("gulf normal", 240)
        .put("guyana", -240)
        .put("hawaiisk sommar", -540)
        .put("hongkong", 480)
        .put("hovd", 420)
        .put("hawaiisk normal", -600)
        .put("indokinesisk normal", 420)
        .put("israelisk sommar", 180)
        .put("iransk sommar", 270)
        .put("irkutsk", 480)
        .put("iransk normal", 210)
        .put("irländsk normal", 60)
        .put("irlandsk normal", 60)
        .put("indisk normal", 330)
        .put("israelisk normal", 120)
        .put("japansk normal", 540)
        .put("kirgizistansk", 360)
        .put("kosrae", 660)
        .put("krasnoyarsk", 420)
        .put("koreansk normal", 540)
        .put("lord howe sommar", 660)
        .put("lord howe normal", 630)
        .put("linjeöarnas", 840)
        .put("linjeoarnas", 840)
        .put("magadan", 660)
        .put("marquesas", -10000)
        .put("amerikansk-mountain sommar", -360)
        .put("marshallöarnas", 720)
        .put("marshalloarnas", 720)
        .put("burmesisk", 390)
        .put("moskva normal", 180)
        .put("amerikansk-mountain normal", -420)
        .put("mauritisk", 240)
        .put("maldivisk", 300)
        .put("malaysisk", 480)
        .put("nykaledonsk", 660)
        .put("newfoundland sommar", -150)
        .put("norfolk", 660)
        .put("nepalesisk", 345)
        .put("nauru", 720)
        .put("newfoundland normal", -210)
        .put("niue", -660)
        .put("nyzeeländsk sommar", 780)
        .put("nyzeelandsk sommar", 780)
        .put("nyzeeländsk normal", 720)
        .put("nyzeelandsk normal", 720)
        .put("omsk normal", 360)
        .put("oral", 300)
        .put("amerikansk-stillahavs sommar", -420)
        .put("peruansk", -300)
        .put("kamchatka", 720)
        .put("papua nya guineansk", 600)
        .put("phoenixöarnas", 780)
        .put("phoenixoarnas", 780)
        .put("filippinsk", 480)
        .put("pakistansk normal", 300)
        .put("saint-pierre och miquelon sommar", -120)
        .put("saint-pierre och miquelon normal", -180)
        .put("pohnpei normal", 660)
        .put("pitcairnöarnas normal", -480)
        .put("pitcairnoarnas normal", -480)
        .put("amerikansk-stillahavs normal", -480)
        .put("palauisk", 540)
        .put("paraguayansk sommar", -180)
        .put("pyongyang", 510)
        .put("paraguayansk", -240)
        .put("qyzylorda", 360)
        .put("réunion", 240)
        .put("reunion", 240)
        .put("sachalin", 660)
        .put("samara", 240)
        .put("sydafrikansk normal", 120)
        .put("solomonöarnas", 660)
        .put("solomonoarnas", 660)
        .put("seychellisk", 240)
        .put("singaporiansk", 480)
        .put("surinamesisk", -180)
        .put("samoansk normal", -660)
        .put("tahitisk", -600)
        .put("tadzjikisk", 300)
        .put("östtimors", 540)
        .put("osttimors", 540)
        .put("turkmenistansk", 300)
        .put("tonga", 780)
        .put("turkisk", 180)
        .put("tuvalu", 720)
        .put("ulaanbaatar sommar", 540)
        .put("ulaanbaatar", 480)
        .put("uruguayansk sommar", -120)
        .put("uruguayansk", -180)
        .put("uzbekistansk", 300)
        .put("venezuelansk normal", -240)
        .put("vladivostok", 600)
        .put("vanuatuansk", 660)
        .put("västafrikansk sommar", 120)
        .put("vastafrikansk sommar", 120)
        .put("västafrikansk", 60)
        .put("vastafrikansk", 60)
        .put("västeuropeisk sommar", 60)
        .put("vasteuropeisk sommar", 60)
        .put("västeuropeisk", 0)
        .put("vasteuropeisk", 0)
        .put("wallis och futuna", 720)
        .put("västgrönländsk sommar", -120)
        .put("vastgronlandsk sommar", -120)
        .put("västgrönländsk", -180)
        .put("vastgronlandsk", -180)
        .put("västindonesisk", 420)
        .put("vastindonesisk", 420)
        .put("östindonesisk", 540)
        .put("ostindonesisk", 540)
        .put("centralindonesisk", 480)
        .put("västsahara sommar", 60)
        .put("vastsahara sommar", 60)
        .put("västsamoansk", 780)
        .put("vastsamoansk", 780)
        .put("västsahara normal", 0)
        .put("vastsahara normal", 0)
        .put("jakutsk", 540)
        .put("yekaterinburg", 300)
        .put("beijing", 480)
        .put("shanghai", 480)
        .put("shenzhen", 480)
        .put("suzhou", 480)
        ...
        .put("central daylight saving", -10000)
        ...
        .put("eastern daylight saving", -10000)
        ...
        .put("mountain", -420)
        .put("mountain daylight", -360)
        .put("mountain daylight saving", -360)
        ...
        .put("australian western daylight saving", 540)
        .put("australian west daylight saving", 540)
        .put("austrialian western daylight saving", 540)
        .put("austrialian west daylight saving", 540)
        .put("colombia", -300)
        .put("hong kong", 480)
        .put("madrid", 60)
        .put("bilbao", 60)
