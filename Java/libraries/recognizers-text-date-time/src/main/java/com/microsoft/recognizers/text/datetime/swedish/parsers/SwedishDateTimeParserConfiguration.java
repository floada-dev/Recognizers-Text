...
public class SwedishDateTimeParserConfiguration extends BaseOptionsConfiguration implements IDateTimeParserConfiguration {
    ...
    public SwedishDateTimeParserConfiguration(ICommonDateTimeParserConfiguration config) {
        ...
        tokenBeforeTime = SwedishDateTime.TokenBeforeTime;
        ...
        amTimeRegex = RegExpUtility.getSafeRegExp(SwedishDateTime.AMTimeRegex);
        pmTimeRegex = RegExpUtility.getSafeRegExp(SwedishDateTime.PMTimeRegex);

        simpleTimeOfTodayAfterRegex = SwedishDateTimeExtractorConfiguration.SimpleTimeOfTodayAfterRegex;
        simpleTimeOfTodayBeforeRegex = SwedishDateTimeExtractorConfiguration.SimpleTimeOfTodayBeforeRegex;
        specificTimeOfDayRegex = SwedishDateTimeExtractorConfiguration.SpecificTimeOfDayRegex;
        specificEndOfRegex = SwedishDateTimeExtractorConfiguration.SpecificEndOfRegex;
        unspecificEndOfRegex = SwedishDateTimeExtractorConfiguration.UnspecificEndOfRegex;
        unitRegex = SwedishTimeExtractorConfiguration.TimeUnitRegex;
        dateNumberConnectorRegex = SwedishDateTimeExtractorConfiguration.DateNumberConnectorRegex;
