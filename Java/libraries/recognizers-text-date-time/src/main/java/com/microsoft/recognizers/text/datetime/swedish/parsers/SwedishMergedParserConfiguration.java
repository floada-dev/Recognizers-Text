...
public class SwedishMergedParserConfiguration extends SwedishCommonDateTimeParserConfiguration implements IMergedParserConfiguration {

    public SwedishMergedParserConfiguration(DateTimeOptions options) {
        super(options);

        beforeRegex = SwedishMergedExtractorConfiguration.BeforeRegex;
        afterRegex = SwedishMergedExtractorConfiguration.AfterRegex;
        sinceRegex = SwedishMergedExtractorConfiguration.SinceRegex;
        aroundRegex = SwedishMergedExtractorConfiguration.AroundRegex;
        suffixAfterRegex = SwedishMergedExtractorConfiguration.SuffixAfterRegex;
        ...
        getParser = new BaseSetParser(new SwedishSetParserConfiguration(this));
        holidayParser = new BaseHolidayParser(new SwedishHolidayParserConfiguration());
    }
