...
public class SwedishDatePeriodParserConfiguration extends BaseOptionsConfiguration implements IDatePeriodParserConfiguration {
    ...
    public SwedishDatePeriodParserConfiguration(ICommonDateTimeParserConfiguration config) {
        ...
        monthFrontBetweenRegex = SwedishDatePeriodExtractorConfiguration.MonthFrontBetweenRegex;
        betweenRegex = SwedishDatePeriodExtractorConfiguration.BetweenRegex;
        monthFrontSimpleCasesRegex = SwedishDatePeriodExtractorConfiguration.MonthFrontSimpleCasesRegex;
        simpleCasesRegex = SwedishDatePeriodExtractorConfiguration.SimpleCasesRegex;
        oneWordPeriodRegex = SwedishDatePeriodExtractorConfiguration.OneWordPeriodRegex;
        monthWithYear = SwedishDatePeriodExtractorConfiguration.MonthWithYear;
        monthNumWithYear = SwedishDatePeriodExtractorConfiguration.MonthNumWithYear;
        yearRegex = SwedishDatePeriodExtractorConfiguration.YearRegex;
        pastRegex = SwedishDatePeriodExtractorConfiguration.PreviousPrefixRegex;
        ...
        weekOfMonthRegex = SwedishDatePeriodExtractorConfiguration.WeekOfMonthRegex;
        weekOfYearRegex = SwedishDatePeriodExtractorConfiguration.WeekOfYearRegex;
        quarterRegex = SwedishDatePeriodExtractorConfiguration.QuarterRegex;
        quarterRegexYearFront = SwedishDatePeriodExtractorConfiguration.QuarterRegexYearFront;
        allHalfYearRegex = SwedishDatePeriodExtractorConfiguration.AllHalfYearRegex;
        seasonRegex = SwedishDatePeriodExtractorConfiguration.SeasonRegex;
        whichWeekRegex = SwedishDatePeriodExtractorConfiguration.WhichWeekRegex;
        weekOfRegex = SwedishDatePeriodExtractorConfiguration.WeekOfRegex;
        monthOfRegex = SwedishDatePeriodExtractorConfiguration.MonthOfRegex;
        restOfDateRegex = SwedishDatePeriodExtractorConfiguration.RestOfDateRegex;
        laterEarlyPeriodRegex = SwedishDatePeriodExtractorConfiguration.LaterEarlyPeriodRegex;
        weekWithWeekDayRangeRegex = SwedishDatePeriodExtractorConfiguration.WeekWithWeekDayRangeRegex;
        yearPlusNumberRegex = SwedishDatePeriodExtractorConfiguration.YearPlusNumberRegex;
        decadeWithCenturyRegex = SwedishDatePeriodExtractorConfiguration.DecadeWithCenturyRegex;
        yearPeriodRegex = SwedishDatePeriodExtractorConfiguration.YearPeriodRegex;
        complexDatePeriodRegex = SwedishDatePeriodExtractorConfiguration.ComplexDatePeriodRegex;
        relativeDecadeRegex = SwedishDatePeriodExtractorConfiguration.RelativeDecadeRegex;
        inConnectorRegex = config.getUtilityConfiguration().getInConnectorRegex();
        withinNextPrefixRegex = SwedishDatePeriodExtractorConfiguration.WithinNextPrefixRegex;
        referenceDatePeriodRegex = SwedishDatePeriodExtractorConfiguration.ReferenceDatePeriodRegex;
        agoRegex = SwedishDatePeriodExtractorConfiguration.AgoRegex;
        laterRegex = SwedishDatePeriodExtractorConfiguration.LaterRegex;
        lessThanRegex = SwedishDatePeriodExtractorConfiguration.LessThanRegex;
        moreThanRegex = SwedishDatePeriodExtractorConfiguration.MoreThanRegex;
        centurySuffixRegex = SwedishDatePeriodExtractorConfiguration.CenturySuffixRegex;
        relativeRegex = RegExpUtility.getSafeRegExp(SwedishDateTime.RelativeRegex);
        unspecificEndOfRangeRegex = RegExpUtility.getSafeRegExp(SwedishDateTime.UnspecificEndOfRangeRegex);
        nowRegex = SwedishDatePeriodExtractorConfiguration.NowRegex;
        ...
        nextPrefixRegex = RegExpUtility.getSafeRegExp(SwedishDateTime.NextPrefixRegex);
        previousPrefixRegex = RegExpUtility.getSafeRegExp(SwedishDateTime.PreviousPrefixRegex);
        thisPrefixRegex = RegExpUtility.getSafeRegExp(SwedishDateTime.ThisPrefixRegex);
        afterNextSuffixRegex = RegExpUtility.getSafeRegExp(SwedishDateTime.AfterNextSuffixRegex);
    }
    ...
    public boolean isYearOnly(String text) {
        String trimmedText = text.trim().toLowerCase();
        return SwedishDateTime.YearTerms.stream().anyMatch(o -> trimmedText.endsWith(o)) ||
            (getYearTermsPadded().anyMatch(o -> trimmedText.contains(o)) && RegExpUtility.getMatches(afterNextSuffixRegex, trimmedText).length > 0) ||
            (SwedishDateTime.GenericYearTerms.stream().anyMatch(o -> trimmedText.endsWith(o)) && RegExpUtility.getMatches(unspecificEndOfRangeRegex, trimmedText).length > 0);
    }
    ...
    private Stream<String> getYearTermsPadded() {
        return SwedishDateTime.YearTerms.stream().map(i -> String.format(" %s ", i));
    }
}
