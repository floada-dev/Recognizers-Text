...
public class SwedishSetParserConfiguration extends BaseOptionsConfiguration implements ISetParserConfiguration {
    ...
    private static Pattern doubleMultiplierRegex =
            RegExpUtility.getSafeRegExp(SwedishDateTime.DoubleMultiplierRegex);

    private static Pattern halfMultiplierRegex =
            RegExpUtility.getSafeRegExp(SwedishDateTime.HalfMultiplierRegex);

    private static Pattern dayTypeRegex =
            RegExpUtility.getSafeRegExp(SwedishDateTime.DayTypeRegex);

    private static Pattern weekTypeRegex =
            RegExpUtility.getSafeRegExp(SwedishDateTime.WeekTypeRegex);

    private static Pattern weekendTypeRegex =
            RegExpUtility.getSafeRegExp(SwedishDateTime.WeekendTypeRegex);

    private static Pattern monthTypeRegex =
            RegExpUtility.getSafeRegExp(SwedishDateTime.MonthTypeRegex);

    private static Pattern quarterTypeRegex =
            RegExpUtility.getSafeRegExp(SwedishDateTime.QuarterTypeRegex);

    private static Pattern yearTypeRegex =
            RegExpUtility.getSafeRegExp(SwedishDateTime.YearTypeRegex);
